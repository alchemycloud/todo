...
import com.todo.backend.service.InitService;
...
public abstract class AbstractApiTest extends AbstractDatabaseTest implements AuthenticationApiMockMvc, UserApiMockMvc, TodoApiMockMvc {
    ...
    public void before() {
        super.before();
        AppThreadLocals.initialize(Optional.empty(), Optional.empty());
