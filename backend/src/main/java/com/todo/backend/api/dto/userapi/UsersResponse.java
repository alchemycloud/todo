...
public class UsersResponse implements Serializable {
    ...
    public UsersResponse(UserId id, String firstName, String lastName, UserRole role, String username, String passwordHash) {
        this();
        this.id = id;
    ...
    public final UsersResponse setRole(UserRole role) {
        this.role = role;
        return this;
    }
    ...
    public final UsersResponse setUsername(String username) {
        this.username = username;
        return this;
    }
    ...
    public final UsersResponse setPasswordHash(String passwordHash) {
        this.passwordHash = passwordHash;
        return this;
    }
