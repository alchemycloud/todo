...
public class UpdateTodoRequest implements Serializable {
    ...
    public UpdateTodoRequest(TodoId id, UserId userId, String task, ZonedDateTime date, Status status) {
        this();
        this.id = id;
        this.userId = userId;
        this.task = task;
    ...
    public final UpdateTodoRequest setId(TodoId id) {
        this.id = id;
        return this;
    }
    ...
    public final UpdateTodoRequest setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final UpdateTodoRequest setTask(String task) {
        this.task = task;
        return this;
    }
    ...
    public final UpdateTodoRequest setDate(ZonedDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public final UpdateTodoRequest setStatus(Status status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (UpdateTodoRequest.class != obj.getClass()) {
            return false;
        }
