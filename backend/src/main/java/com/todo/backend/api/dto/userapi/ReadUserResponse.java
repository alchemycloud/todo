...
public class ReadUserResponse implements Serializable {
    ...
    public ReadUserResponse(UserId id, String firstName, String lastName, UserRole role, String username, String passwordHash) {
        this();
        this.id = id;
    ...
    public final ReadUserResponse setId(UserId id) {
        this.id = id;
        return this;
    }
    ...
    public final ReadUserResponse setFirstName(String firstName) {
        this.firstName = firstName;
        return this;
    }
    ...
    public final ReadUserResponse setLastName(String lastName) {
        this.lastName = lastName;
        return this;
    }
    ...
    public final ReadUserResponse setRole(UserRole role) {
        this.role = role;
        return this;
    }
    ...
    public final ReadUserResponse setUsername(String username) {
        this.username = username;
        return this;
    }
    ...
    public final ReadUserResponse setPasswordHash(String passwordHash) {
        this.passwordHash = passwordHash;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (ReadUserResponse.class != obj.getClass()) {
            return false;
        }
