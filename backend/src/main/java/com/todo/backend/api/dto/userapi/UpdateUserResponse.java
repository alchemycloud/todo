...
public class UpdateUserResponse implements Serializable {
    ...
    public UpdateUserResponse(UserId id, String firstName, String lastName, UserRole role, String username, String passwordHash) {
        this();
        this.id = id;
    ...
    public final UpdateUserResponse setUsername(String username) {
        this.username = username;
        return this;
    }
