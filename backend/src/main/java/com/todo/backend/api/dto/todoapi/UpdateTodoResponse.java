...
public class UpdateTodoResponse implements Serializable {
    ...
    public UpdateTodoResponse(TodoId id, UserId userId, String task, ZonedDateTime date, Status status) {
        this();
        this.id = id;
        this.userId = userId;
        this.task = task;
    ...
    public final UpdateTodoResponse setId(TodoId id) {
        this.id = id;
        return this;
    }
    ...
    public final UpdateTodoResponse setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final UpdateTodoResponse setTask(String task) {
        this.task = task;
        return this;
    }
    ...
    public final UpdateTodoResponse setDate(ZonedDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public final UpdateTodoResponse setStatus(Status status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (UpdateTodoResponse.class != obj.getClass()) {
            return false;
        }
