...
public class CreateUserResponse implements Serializable {
    ...
    public CreateUserResponse(UserId id, String firstName, String lastName, UserRole role, String username, String passwordHash) {
        this();
        this.id = id;
    ...
    public final CreateUserResponse setUsername(String username) {
        this.username = username;
        return this;
    }
