...
public class DeleteTodoRequest implements Serializable {
    ...
    public DeleteTodoRequest(TodoId id) {
        this();
        this.id = id;
    }
    ...
    public final DeleteTodoRequest setId(TodoId id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (DeleteTodoRequest.class != obj.getClass()) {
            return false;
        }
    ...
    public String toString() {
        return "DeleteTodoRequest[" + "this.id=" + this.id + "]";
    }
}
