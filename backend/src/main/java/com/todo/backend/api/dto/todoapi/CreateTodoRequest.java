...
public class CreateTodoRequest implements Serializable {
    ...
    public CreateTodoRequest(UserId userId, String task, ZonedDateTime date, Status status) {
        this();
        this.userId = userId;
        this.task = task;
        this.date = date;
    ...
    public final CreateTodoRequest setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final CreateTodoRequest setTask(String task) {
        this.task = task;
        return this;
    }
    ...
    public final CreateTodoRequest setDate(ZonedDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public final CreateTodoRequest setStatus(Status status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (CreateTodoRequest.class != obj.getClass()) {
            return false;
        }
