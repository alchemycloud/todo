...
public class ReadTodoResponse implements Serializable {
    ...
    private ReadTodoResponse() {}

    public ReadTodoResponse(TodoId id, UserId userId, String task, ZonedDateTime date, Status status) {
        this();
        this.id = id;
        this.userId = userId;
        this.task = task;
    ...
    public final ReadTodoResponse setId(TodoId id) {
        this.id = id;
        return this;
    }
    ...
    public final ReadTodoResponse setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final ReadTodoResponse setTask(String task) {
        this.task = task;
        return this;
    }
    ...
    public final ReadTodoResponse setDate(ZonedDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public final ReadTodoResponse setStatus(Status status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (ReadTodoResponse.class != obj.getClass()) {
            return false;
        }
