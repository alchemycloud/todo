...
public class UserTodosResponse implements Serializable {
    ...
    private UserTodosResponse() {}

    public UserTodosResponse(TodoId id, UserId userId, String task, ZonedDateTime date, Status status) {
        this();
        this.id = id;
        this.userId = userId;
        this.task = task;
    ...
    public final UserTodosResponse setId(TodoId id) {
        this.id = id;
        return this;
    }
    ...
    public final UserTodosResponse setUserId(UserId userId) {
        this.userId = userId;
        return this;
    }
    ...
    public final UserTodosResponse setTask(String task) {
        this.task = task;
        return this;
    }
    ...
    public final UserTodosResponse setDate(ZonedDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public final UserTodosResponse setStatus(Status status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (UserTodosResponse.class != obj.getClass()) {
            return false;
        }
